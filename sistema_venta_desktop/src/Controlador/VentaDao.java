...
public class VentaDao {
    ...
    public void pdfV(int idventa, int Cliente, double total, String usuario) {
        try {
            ...
            doc.open();
            Image img = Image.getInstance(getClass().getResource("/Img/337946.png"));
                //Fecha
                Paragraph fecha = new Paragraph();
                Font negrita = new Font(Font.FontFamily.HELVETICA, 13, Font.BOLD, BaseColor.BLACK );
                ...
                float[] columnWidthsEncabezado = new float[]{20f, 30f, 70f, 50f};
            ...
            proveedor.getDefaultCell().setBorder(1);    
            float[] columnWidthsCliente = new float[]{25f, 25f, 25f};
            ...
            float[] columnWidths = new float[]{10f, 15f, 15f, 10f};
            ...
            PdfPCell c3 = new PdfPCell(new Phrase("Precio Unitario.", negrita));
            PdfPCell c4 = new PdfPCell(new Phrase("Sub Total", negrita));
